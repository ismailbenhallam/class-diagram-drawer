...
public class DrawingRelation {
	...
	// Dessiner le trait pointillè + flèche qui exprime l'hèritage dans le langage
	...
	// Dessiner le trait + flèche qui exprime l'hèritage dans le langage UML
	...
	// Initialize les points du triangle è dessiner selon le PointLocation
